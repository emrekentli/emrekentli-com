...
export function SocialLinks() {
  return (
    <div className="flex items-center justify-center mt-4 space-x-4 text-sm">
      <Link href="https://github.com/emrekentli" className="flex items-center justify-center space-x-2 text-zinc-600 dark:text-zinc-400 hover:text-black dark:hover:text-white transition-colors group">
      ...
      <Link href="https://www.linkedin.com/in/emrekentli" className="flex items-center justify-center space-x-2 text-zinc-600 dark:text-zinc-400 hover:text-black dark:hover:text-white transition-colors group">
        <svg className="w-5 h-5" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
